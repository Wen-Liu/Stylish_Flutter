...
List<dynamic> getProductListData(String title, int listSize, String imagePath) {
...
List<dynamic> getAllProductListData() {
  List<dynamic> list = [];
  list.addAll(
      getProductListData("女裝", 3, "assets/images/women_image.png"));
  list.addAll(
      getProductListData("男裝", 5, "assets/images/men_image.jpeg"));
  list.addAll(
